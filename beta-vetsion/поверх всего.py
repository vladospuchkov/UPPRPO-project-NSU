...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QPushButton, QLineEdit, QLCDNumber, QGridLayout, 
                             QHBoxLayout, QStackedWidget, QTextEdit, QLabel, QMenuBar, QAction, QCheckBox)
...
class AppWindow(QWidget):
    ...
    def update_styles(self):
        ...
        self.menu_bar.setStyleSheet(self.get_window_style())
        self.language_menu.setStyleSheet(self.get_window_style())
